...
def main_process_user_locations(
    ...
    coordinate_data, _ = euclidean_distance(df_a=satellite_metadata, df_b=df)

    path_df = user_path_finder(image_folder=image_folder, user_coordinate_data=coordinate_data)

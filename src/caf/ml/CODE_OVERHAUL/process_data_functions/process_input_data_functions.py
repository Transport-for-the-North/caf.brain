...
import numpy as np
import pandas as pd
from caf.ml.CODE_OVERHAUL.inputs_and_baseclasses.baseclasses import ValidateData
...
class InitialDataProcessing:
    ...
    # # # Data flow pipelines # # #
    def execute_pipeline(self) -> Dict[str, pd.DataFrame]:
        """
    ...
    def process_dataframes(self) -> None:
        """
        Process dataframe(s).
        """
    ...
    def transform_target_column(df, target_column, binary_prediction):
        ...
        if binary_prediction == 'multiclass':
            print('Multiclass model selected')

...
"""
from caf.ml.backlog.functions_to_be_processed.forecast_model_functions import process_data_loaded_model, \
...
from caf.ml.backlog.functions_to_be_processed.NorCom_caf_ml.larger_cafml_model.norcom_specific_functions import apply_transformations_norcom
...
def saved_model_func(params, regression_method, hyperparameters, trained_data, transformations, data_analysis_data):
    ...
    final_predict_data = align_dataframes(df1=trained_data, df2=dat,
                                          output_folder=params.output_folder)

...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/transport-for-the-north/caf.brain",
    ...
    "external_links": [
        {
            "name": "Changelog",
            "url": "https://github.com/transport-for-the-north/caf.brain/releases",
        },
        {
            "name": "Issues",
            "url": "https://github.com/transport-for-the-north/caf.brain/issues",
        },
        {
            "name": "CAF Handbook",

...
def assumption_analysis(model):
    ...
    _, shapiro_p_value = shapiro(model.resid)
    ...
    _, bp_test_p_value, _, _ = het_breuschpagan(model.resid, model.model.exog)
    ...
    _, white_test_p_value, _, _ = het_white(model.resid, model.model.exog)

...
from caf.brain.machine_vision.object_detection_satellites.yolo_modelling.data_processing.build_yolo_config import build_config
from caf.brain.machine_vision.object_detection_satellites.yolo_modelling.model_creation.model_creation_main import main_model_build
from pathlib import Path


def main_model_building(output_path: Path,
    ...
    if not os.path.exists(train_folder_name):
        imageprocessor = BuildImagesTT(output=main_output_folder,
                                       image_dict=None,
                                       image_location=image_folder_path)

...
from caf.brain.machine_vision.object_detection_satellites.satellite_image_processing.satellite_metadata_processing.xml_processing_functions import main_process_xml


def main_satellite_metadata(folder_path: Path,
                            output_path: Path,
                            satellite_image_metadata: Path = None) -> pd.DataFrame:
    ...
    image_xml_df = main_process_xml(folder_path=folder_path,

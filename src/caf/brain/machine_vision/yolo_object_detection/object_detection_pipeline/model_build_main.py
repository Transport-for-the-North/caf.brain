...
# Local Imports
from caf.brain.machine_vision.yolo_object_detection.hyperparameter_optimisation_yolo.hyperparameter_optimisation_main import (
    main_hyperparameter_optimisation,
)
from caf.brain.machine_vision.yolo_object_detection.object_detection_pipeline.yolo_models import (
    baseline_model,
    final_model,
)
...
def main_model_build(output, hyperparameter_optimisation, path_to_code):
    ...
    final_training_results, final_model_path = final_model(
        output=model_dir, config_path=config_path
    )

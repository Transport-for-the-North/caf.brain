...
def main_image_generation(image_folder_path,
                          output_path,
    ...
    metadata = main_satellite_metadata(folder_path=image_folder_path,
                                       output_path=output_path,
                                       satellite_image_metadata=satellite_image_metadata)


    user_coordinate_data = main_process_user_locations(user_locations_path=user_locations_path,
                                                       output_path=output_path,
    ...
    image_crop_main(user_coordinate_data=user_coordinate_data,
                    output=output_path,
                    image_folder=image_folder_path,
                    satellite_metadata=metadata)

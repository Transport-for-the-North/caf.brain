...
#     ).data
#
#     processed_training, transformations_ = process_data_pipeline(
#         df=processed_data,
...
#     )
#
#     processed_predict = apply_transformations(
...
#         model, predictions = train_improved_model(
#             X_train=X_train,
#             y_train=y_train,
#             X_predict=processed_predict,
#             y_validate=validate,
...
#         )
#
#     coef_stats = calculate_coefficient_stats(
#         model, X_train, y_train, output_folder=params.output_folder
#     )

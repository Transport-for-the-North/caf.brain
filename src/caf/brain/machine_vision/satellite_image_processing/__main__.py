...
# Local Imports
from caf.brain.machine_vision.junction_detection_functions.noham_processing.noham_processing_main import (
    main_process_noham,
)
from caf.brain.machine_vision.satellite_image_processing.input_processing.input_processing_functions import (
    process_file,
)
from caf.brain.machine_vision.satellite_image_processing.input_processing.input_processing_main import (
...
def main(params):
    ...
    if params.generate_training_images:
        if params.noham_path and params.geo_path is not None:
            LOG.info(
                "It is recommended to process any Noham data outside of the model \
            ...
            training_data_info = main_process_noham(
                output_path=output_path, noham_path=params.noham_path, geo_path=params.geo_path
            )
            ...
            LOG.info(
                "Reading in training data information. This must be built from \
